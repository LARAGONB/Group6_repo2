...
[Interactive effects for most parsimonious Titanic model predicting survivability using gender and class as interactive factors.](Interactive effects of Best Titanic model.png)

[Residual plots for the Best Titanic model. These figures visualize the residuals to see if there are any differences in the variability of residuals as the value for each predictor variable increases.](Residual plots for the Best titanic model.png) 
